...
| a file that is not identifiable as an export at all (name says neither order nor income; not a Lazada schema) | **skipped** | a team analysis workbook in the dump folder is not a missing export. A password-protected file is *named*, not a traceback ([D6](06-DECISIONS.md#d6)) |
