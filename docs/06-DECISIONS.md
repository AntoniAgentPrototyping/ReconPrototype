...
The default is `report`, deliberately: `off` would leave the path unexercised until the day it is first trusted with money, which is the worst possible day to discover it.
